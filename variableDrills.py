...
listString=["class","her","rock","his","tea"]
...
zeroIndex=listBoolean[0]
firstIndex=listBoolean[1]
secondIndex=listBoolean[2]
thirdIndex=listBoolean[3]
fourthIndex=listBoolean[4]
print(zeroIndex)
print(firstIndex)
print(secondIndex)
print(thirdIndex)
